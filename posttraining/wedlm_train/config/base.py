# coding=utf-8
"""Base training configuration shared across SFT / DPO / GSPO modes."""
...
class BaseTrainingConfig:
    """Shared training configuration for all modes."""
    ...
    def __post_init__(self):
        ...
        if not self.mask_per_block:
            import warnings
            warnings.warn(
                "mask_per_block=False does not match the paper's design.",
                UserWarning,
            )
    ...
    @classmethod
    def from_yaml(cls, path: str) -> "BaseTrainingConfig":
        """Load config from YAML. Subclasses override to dispatch by training_mode."""
