# coding=utf-8
"""Model forward pass with WeDLM attention — self-contained for gspo/."""

import torch
import torch.nn as nn

from gspo.src.batch import WeDLMBatch
...
def wedlm_forward(
    ...
    Args:
        model: HuggingFace AutoModelForCausalLM instance (HF checkpoint format).
        batch: WeDLMBatch with packed_input_ids, logical_positions, attention plan.
        attn_wrapper: MagiAttentionWrapper or DenseAttentionWrapper.
        backend: "magi" or "dense".

    Returns:
        Logits tensor [T, V] over the packed sequence.
    """
